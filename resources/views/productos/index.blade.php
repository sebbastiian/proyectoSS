...
<div class="crear">
    <div>
        <a class="a" href="{{route('productos.create')}}">
            <div class="crearb">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user-plus" width="40" height="40" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    <path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" />
                    <path d="M16 19h6" />
                    <path d="M19 16v6" />
        ...
        <table class="tabla">
            ...
            <tr>
                ...
                @else
                    Sin Imagen
                @endif
                <td class="botonc"><a class="boton edit" href="{{route('productos.edit',$fila ->idproducto)}}"><button>Editar</button></a></td>
                </td>
            </tr>
            @empty
            @endforelse
